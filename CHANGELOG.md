...
- [#72](https://github.com/Sqrrl/wc-datepicker/pull/72) [`c4c2c92`](https://github.com/Sqrrl/wc-datepicker/commit/c4c2c929dde6863cebc6ad482fbfbdc33b15c78c) Thanks [@Sqrrl](https://github.com/Sqrrl)! - Add `selection-mode` prop with support for `'single' | 'range' | 'multiple'`.
